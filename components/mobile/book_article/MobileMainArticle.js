      ...
      <div className="bg-light-less-gray min-vh-100">
        ...
        <BreadcrumbMB 
          item={[
            ...
            {text: t('article'),active:true}
          ]}
        />
        <div className="container py-3 bg-white">
          <div className="d-flex justify-content-center ">
            <div>
              <h1 className="text-black text-h4 mb-0">{t("article")}</h1>
            </div>
          </div>
        </div>
        <div className="all-card-news ">
          <div className="container py-3 bg-white">
            <div className="d-flex justify-content-between ">
              <div>
                <h4 className="text-black">{t("article")}</h4>
              </div>
            ...
            <div className="d-flex justify-content-start all-card-book">
              {
                articles ? articles.rows.slice(0,3).map((news, index) => <CardNews news={news} type="bookarticle" key={index} />) : ''
              }
...
export default MobileMainArticle