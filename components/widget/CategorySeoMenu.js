...
const CategorySeoMenu = memo(({platform = "desktop",t,cateData}) =>{
			...
			}
			{
				...
				<div className="position-relative">
					...
					<div className={classNames("popover-category", { "show": showHam,"active":cateID!==undefined })} >
						...
						<div className={classNames("seocate", { "show": showSublist })}>
							<div className={classNames("popover-category-list-new", { "show": showSublist })}>
								{
									cateData ? cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))?.map((val, index) => (
										<Fragment key={index}>
                      <div className={`show-cate ${cateID == index ? 'active' : ''}`}>
                        <div className={`main-cate-all ${cateID == index ? 'active' : ''}`}>
                          <Link 
                            ...
                            as={activeTap == `book` ? `/books/${val.url_name}` : activeTap == `ebook` ? `/ebooks/${val.url_name}` : activeTap == "course" ? `/courses/${val.url_name}` : `/stationeries/${val.url_name}`}>
                              <a className="text-black">
                                <span className={classNames('font-h5 cursor-pointer', activeTap == "book" ? 'book-color' : activeTap == "ebook" ? 'ebook-color' : activeTap == "course" ? 'course-color' : 'write-color')}>{val.name_th} {t('all')}</span>
                              </a>
                          </Link>
                        </div>
                        <div className={`grid ${cateID == index ? 'active' : ''}`}>
                          {
                            (cateData) ? cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index]?.subs?.map((val2, index2) => (
                              <div className="subcategory-list" key={index2}>
                                <ul className="subcategory-list-title">
                                  <Link 
                                    href={activeTap == `book` ? `/books/[main_category]/[sub_category]?main_category=${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}&sub_category=${val2.url_name}` : activeTap == `ebook` ? `/ebooks/[main_category]/[sub_category]?main_category=${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}&sub_category=${val2.url_name}` : activeTap == "course" ? `/courses/[main_category]/[sub_category]?main_category=${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}&sub_category=${val2.url_name}` : `/stationeries/[main_category]/[sub_category]?main_category=${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}&sub_category=${val2.url_name}`} 
                                    as={activeTap == `book` ? `/books/${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}/${val2.url_name}` : activeTap == `ebook` ? `/ebooks/${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}/${val2.url_name}` : activeTap == "course" ? `/courses/${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}/${val2.url_name}` : `/stationeries/${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}/${val2.url_name}`}>
                                    <a className="text-black">
                                      <span className='font-h5'>{val2.name_th}</span>
                                    </a>
                                  </Link>
                                  {
                                    cateData ? cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index]?.subs[index2]?.items?.map((val3, index3) => (
                                      <Link key={index3} 
                                        href={activeTap == `book` ? `/books/[main_category]/[sub_category]/[category]?main_category=${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}&sub_category=${val2.url_name}&category=${val3.url_name}` : activeTap == `ebook` ? `/ebooks/[main_category]/[sub_category]/[category]?main_category=${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}&sub_category=${val2.url_name}&category=${val3.url_name}` : activeTap == "course" ? `/courses/[main_category]/[sub_category]/[category]?main_category=${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}&sub_category=${val2.url_name}&category=${val3.url_name}` : `/stationeries/[main_category]/[sub_category]/[category]?main_category=${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}&sub_category=${val2.url_name}&category=${val3.url_name}`} 
                                        as={activeTap == `book` ? `/books/${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}/${val2.url_name}/${val3.url_name}` : activeTap == `ebook` ? `/ebooks/${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}/${val2.url_name}/${val3.url_name}` : activeTap == "course" ? `/courses/${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}/${val2.url_name}/${val3.url_name}` : `/stationeries/${cateData?.filter(v => v.type == (activeTap == "ebook" ? "book" : activeTap))[index].url_name}/${val2.url_name}/${val3.url_name}`}>
...
export default withTranslation(['header', 'noti'])(CategorySeoMenu)