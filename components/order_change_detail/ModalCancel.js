...
const ModalCancel = ({ changes, show, handleClose, t ,onConfirm, note, setNote, modalShow, setModalShow, handleModalClose}) => {
          ...
          <>
            <Modal className="modal-cart" show={show} centered onHide={handleClose} size="lg">
              <Modal.Header closeButton>
                <Modal.Title className="font-20">{t("link_cancel_change")}</Modal.Title>
              </Modal.Header>
