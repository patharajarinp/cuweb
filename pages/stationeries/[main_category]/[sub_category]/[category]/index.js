...
const MainProducts = (props) =>{
  ...
  const pathname = `/stationeries/${main_category}/${sub_category}/${category}`
      ...
      />
      {
        !isMobile ? (
          <MainFilter 
            ...
            setLoading={setLoading} breadcrumb={false} level={3} page_path={`stationeries`} 
...
MainProducts.getInitialProps = async ({query, req}) => {
  ...
  try {
    ...
    return {query,products,cates, cateIndex, main_category : main.url_name, sub_category : sub.url_name, category : cate.url_name, main : cate,currentLanguage, seller,
