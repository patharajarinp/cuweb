      ...
      <div className="container">
        ...
        <div className="d-none d-xl-block">
          <div className="row mt-5 pb-4">
            {
              bookArticles ? bookArticles.rows.map((news) => <CardNews news={news} type="bookarticle" t={t} />) : ''
            }
          </div>
        </div>
        <div className="d-block d-xl-none">
          <div className="row mt-5 pb-4">
            {
              bookArticles ? bookArticles.rows.map((news) => <CardNews news={news} type="bookarticle" show={3} t={t} />) : ''
            }
          </div>
        </div>
