...
const MobileMainStationeries = (props) => {
    ...
    <>
      ...
      <div className="bg-light-less-gray pt-3">
        <div className="container bg-white ">
          <h4 className="text-black text-center py-3">{t("header:category")}{t("header:stationery")}</h4>
              ...
              <div className="container py-3">
                <div className="d-flex justify-content-between ">
                  ...
                  <Link href={`/recommend/[key]?key=${val.key}`} as={`/recommend/${val.key}`}>
                    <a ><p className="text-stationery see-all-link">{t("translations:view_all")} </p></a>
                  </Link>
                </div>
...
export default MobileMainStationeries