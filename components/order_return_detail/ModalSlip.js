...
const ModalSlip = ({ returns, show, handleClose, t ,onConfirm, data, setData, modalShow2, setModalShow2, handleModalClose2}) => {
          ...
          <>
            <Modal className="modal-cart" show={show} centered onHide={handleClose} size="lg">
              <Modal.Header closeButton>
                <Modal.Title className="font-20">{t("Order:return_slip")}</Modal.Title>
              </Modal.Header>
