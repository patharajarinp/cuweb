...
const SubProducts = (props) =>{
  ...
  const pathname = `/ebooks/${main_category}/${sub_category}`
      ...
      />
      {
        !isMobile ? (
          <MainFilter 
            ...
            setLoading={setLoading} breadcrumb={false} level={2} page_path={`ebooks`} level1_id={main_category}  level2_id={sub_category}
            main={main}
            show_all={false}
            currentLanguage={currentLanguage}
            seller={seller}
