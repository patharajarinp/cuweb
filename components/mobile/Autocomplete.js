...
class Autocomplete extends Component {
  ...
  render() {
    ...
    if (showSuggestions && userInput) {
      ...
      btncancel=(<h4 className="text-pink my-auto ml-3" onClick={onClickCancel}>{t("cancel")}</h4>);
        ...
        suggestionsListComponent = (
          <div className="area-rerult">
            <div className="no-suggestions">
              <em className="ml-3">{t("data_not_found")}</em>
            </div>
          </div>
        );
      }
        ...
        <div className= {inputComponent}>
          <div className={inputarea}>
            ...
            <input type="text"
              ...
              onKeyDown={onKeyDown}
              value={userInput} placeholder={t("type_book_name_author")} className="autocomplete-input"  />
          </div> 
         { btncancel}
          </div>
...
export default withTranslation('header')(Autocomplete);
