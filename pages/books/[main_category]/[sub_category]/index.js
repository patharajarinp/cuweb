...
const SubProducts = (props) =>{
  ...
  const pathname = `/books/${main_category}/${sub_category}`
  ...
  return (
    <Layout cateData={cateIndex}>
      ...
      />
      {
        !isMobile ? (
          <MainFilter 
            t={t} query={query} pathname={pathname} local={local} products={products} type={"book"} s_category={s_category}
            setLoading={setLoading} breadcrumb={false} level={2} page_path={`books`} level1_id={main_category}  level2_id={sub_category}
            main={main}
            show_all={false}
            currentLanguage={currentLanguage}
            seller={seller}
          ...
          <>
            ...
            <MobileMainFilter 
              cates={cates}
              t={t} query={query} pathname={pathname} products={products} type={"book"} s_category={s_category}
              setLoading={setLoading} breadcrumb={false} level={2} page_path={`books`} level1_id={main_category}  level2_id={sub_category}
              main={main}
              currentLanguage={currentLanguage}
              isSeller={seller ? true : false}
...
SubProducts.getInitialProps = async ({query, req}) => {
  ...
  try {
    ...
    var params = { ...query, limit: LIMIT, type : 'book', search : query.text };
