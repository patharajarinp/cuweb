...
const MainOrderChange = (props) => {
  ...
  return ( 
    <>
      <Sidenav user={user} menuToggle={true} page="order_change" >
        {
          changes ? (
                ...
                <div className="row w-100 mx-0 px-0">
                  <div className="col-12 pl-0">
                    <div className="mt-2 mb-4">
                      <h6 className="text-black">{t("change_product")}</h6>
                    </div>
                  </div>
                </div>
                  ...
                  changes.count > 0 ? (
                    <>
                      <div className="row w-100 mx-0 px-0">
                        <div className="col-12 px-0">
                          <div className="">
                            {
                              changes ? changes.rows.map((val, index) => (
                                <MainChange changes={val} key={index} type='changes' />
                              )) : ''
                            }
                          </div>
                        </div>
                    ...
                    <div className="col-12 row align-items-center">
                      ...
                      <div className="col-4 no-favorite text-center">
                        <img src="/images/not-cart.svg" className="img-fluid" />
...
export default MainOrderChange