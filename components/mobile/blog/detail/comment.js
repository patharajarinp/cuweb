...
export default function Comment({
  ...
  const postComment = async (e, type, id) => {
    ...
    if (user != undefined) {
      ...
      // await onPostComment(data, type);
    } else {
      Router.push(`/login?redirect=/blog/${group_id}/${data_id}`);
    }
  };
  ...
  return (
    <div className="blog-comment-component my-3">
     ...
     <ProblemModal handleClose={handleClose} show={show} user={user} blog={blog} group_id={group_id} data_id={data_id} commentId={commentId} type={2} />
      ...
      >
        ...
        <div className="d-flex justify-content-center align-items-center">
          ...
          <button className="blog-detail-story-detail-card-btn-n w-50 p-0 py-1" type="submit">
            {t('send_comment')}
          </button>
        </div>
      </form>
        ...
        <>
                ...
                <div   key={index}  >
                  ...
                  >
                    ...
                    <div className={`blog-comment-component-item blog-comme  ${addNew == val.id ? "blog-new" : ""}`}>
                      ...
                      <div className="blog-comment-col-1 mt-3 pb-3 pl-3 pr-3">
                          ...
                          <div
                              className="blog-comment-component-item-img mr-2"
                              style={{
                                backgroundImage: `url("${val.user.picture||'/mobile/image/user/no-picture.png'}")`,
                              }}
                            ></div>
                            <div>
                              <p className="m-0">
                      ...
                      <div className="blog-comment-col-2 text-right  mt-3 pb-3 pl-3 pr-3">
                        <p className="m-0 blog-comment-component-item-txt-g">
                            {formatDate(val.createdAt)}
                          </p>
                      </div>
                      <div className="blog-comment-col-3 pl-3 pr-3">
                         <p
                            className={`m-0 blog-comment-component-item-txt-g font-16 ${
                            ...
                            user.id == val.user.id ? (
                              <>
                                <img
                                  ...
                                  src="/mobile/icon/blog/blog-be-icon-edit.svg"
                                />
                              </>
                            ) : null}
                          </p>
                          ...
                          >
                            ...
                            <div className="d-flex justify-content-end align-items-center">
                              ...
                              <button
                                className="blog-detail-story-detail-card-btn-b px-1 py-1 mr-3"
                                type="button"
                                onClick={() => {
                                  onClickChekEdit(val);
                                }}
                      ...
                      <div className="blog-comment-col-4 mt-4 pl-3 pr-3 pb-3">
                        <div
                          ...
                          >
                            <img
                              className="mr-2"
                              src="/mobile/icon/blog/blog-icon-reply.svg"
                            />
                      ...
                      <div className="blog-comment-col-5 mt-4 pl-3 pr-3 pb-3">
                          ...
                          {user && user.id != val.user.id &&  
                            ...
                            >
                              ...
                              <img
                                ...
                                src="/mobile/icon/blog/blog-icon-alert-b.svg"
                              />
                      ...
                      <div className="blog-comment-component-item-repry">
                                ...
                                <div className="blog-comment-grid">
                                  <div className="blog-comment-col-1 mt-3 pb-3 pl-3 pr-3">
                                   ...
                                   <div
                                     className="blog-comment-component-item-img mr-2"
                                     style={{
                                       backgroundImage: `url("${vall.user.picture||'/mobile/image/user/no-picture.png'}")`,
                                     }}
                                   ></div>
                                   <div>
                                     <p className="m-0">
                                  ...
                                  {/* <div className="blog-comment-col-4 mt-4 pl-3 pr-3 pb-3"></div> */}
                                  <div className="blog-comment-col-5 mt-4 pl-3 pr-3 pb-3">
          ...
          {limit < all ? (
              ...
              <div className="text-center w-100">
                <button
                  className="blog-detail-story-detail-card-btn-b p-0 py-1 w-50 mt-3 mr-0"
                  type="button"
                  onClick={() => {{
