...
export default function SlideFolow({ writer }) {
  ...
  return (<>
    {follow  && follow.length > 0 &&  <div className="all-card-book-none-text-left bg-white my-3">
    <div className="container py-3">
      <h3 className="mb-4">ผู้ติดตาม {writer
                  ? formatNum(writer.blog_writer_stat.followed):0} คน</h3>
